...
from License_Plate_Recognition_Model import Main
from License_Plate_Recognition_Model import Preprocess
from License_Plate_Recognition_Model import PossibleChar
...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("License_Plate_Recognition_Model/classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("License_Plate_Recognition_Model/flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
